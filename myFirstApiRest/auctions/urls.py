...
path('auctions/<int:auction_id>/bid/', BidListCreate.as_view(), name='bid-list-create'),
path('auctions/<int:auction_id>/bid/<int:pk>/', BidRetrieveUpdateDestroy.as_view(), name='bid-detail'),
